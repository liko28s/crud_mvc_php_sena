...
class Cliente extends \Core\Modelo
{
    ...
    public static function crear($datos)
    {
        ...
        return $db->query("INSERT INTO clientes($columnas) values ($valores)");
    }
    ...
    public static function actualizar($datos)
    {
        ...
        return $db->query("UPDATE clientes set {$valores} where id={$datos['id']}");
    }
